...
class VSPackage1WindowPane :
	public CComObjectRootEx<CComSingleThreadModel>,
	public VsWindowPaneFromResource<VSPackage1WindowPane, IDD_VSPackage1_DLG>,
	public VsWindowFrameEventSink<VSPackage1WindowPane>,
...
{
	VSL_DECLARE_NOT_COPYABLE(VSPackage1WindowPane)

protected:

	// Protected constructor called by CComObject<VSPackage1WindowPane>::CreateInstance.
	VSPackage1WindowPane() :
...
BEGIN_COM_MAP(VSPackage1WindowPane)
...
BEGIN_MSG_MAP(VSPackage1WindowPane)
...
END_MSG_MAP()
	...
	{
		VsWindowFrameEventSink<VSPackage1WindowPane>::SetSite(GetVsSiteCache());
...
class VSPackage1ToolWindow :
	public VSL::ToolWindowBase<VSPackage1ToolWindow>
{
public:
	...
	VSPackage1ToolWindow(const PackageVsSiteCache& rPackageVsSiteCache):
	...
	IUnknown* GetViewObject()
	{
		...
		CComObject<VSPackage1WindowPane>* pViewObject;
		VSL_CHECKHRESULT(CComObject<VSPackage1WindowPane>::CreateInstance(&pViewObject));
