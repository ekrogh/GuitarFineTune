...
class eksVariableToneCtrlDocWin;
...
private:
    ...
    #if (JUCE_IOS )
        std::set<std::string> noSafeZoneiPhoneiPads =
        {
    ...
    std::shared_ptr <eksVariableToneCtrlDocWin> dw = nullptr;
    //eksVariableToneCtrl* dw = nullptr;
...
#if (JUCE_IOS )
    bool thisIsASafeZoneiPhoneOriPad = true;
#endif
