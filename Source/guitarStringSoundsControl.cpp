      ...
      viewPortAdded(addVWP)
{
    ...
    PlayToneGroupComponent.reset (new juce::GroupComponent ("PlayToneGroupComponent",
    ...
    A2soundToggleButton->setColour (juce::ToggleButton::textColourId, juce::Colours::cornflowerblue);
    ...
    D3soundToggleButton->setColour (juce::ToggleButton::textColourId, juce::Colours::cornflowerblue);
    ...
    G3soundToggleButton->setColour (juce::ToggleButton::textColourId, juce::Colours::cornflowerblue);
    ...
    B3soundToggleButton->setColour (juce::ToggleButton::textColourId, juce::Colours::cornflowerblue);
    ...
    E4soundToggleButton->setColour (juce::ToggleButton::textColourId, juce::Colours::cornflowerblue);
    ...
    inputMuteToggleButton->setToggleState (true, juce::dontSendNotification);
    ...
    E2label->setColour (juce::Label::textColourId, juce::Colours::cornflowerblue);
    E2label->setColour (juce::TextEditor::textColourId, juce::Colours::black);
    E2label->setColour (juce::TextEditor::backgroundColourId, juce::Colour (0x00000000));
    ...
    A2label->setColour (juce::Label::textColourId, juce::Colours::cornflowerblue);
    A2label->setColour (juce::TextEditor::textColourId, juce::Colours::black);
    A2label->setColour (juce::TextEditor::backgroundColourId, juce::Colour (0x00000000));
    ...
    D3label->setColour (juce::Label::textColourId, juce::Colours::cornflowerblue);
    D3label->setColour (juce::TextEditor::textColourId, juce::Colours::black);
    D3label->setColour (juce::TextEditor::backgroundColourId, juce::Colour (0x00000000));
    ...
    G3label->setColour (juce::Label::textColourId, juce::Colours::cornflowerblue);
    G3label->setColour (juce::TextEditor::textColourId, juce::Colours::black);
    G3label->setColour (juce::TextEditor::backgroundColourId, juce::Colour (0x00000000));
    ...
    B3label->setColour (juce::Label::textColourId, juce::Colours::cornflowerblue);
    B3label->setColour (juce::TextEditor::textColourId, juce::Colours::black);
    B3label->setColour (juce::TextEditor::backgroundColourId, juce::Colour (0x00000000));
    ...
    E4label->setColour (juce::Label::textColourId, juce::Colours::cornflowerblue);
    E4label->setColour (juce::TextEditor::textColourId, juce::Colours::black);
    E4label->setColour (juce::TextEditor::backgroundColourId, juce::Colour (0x00000000));
    ...
    sourceRawToggleButton->setToggleState (true, juce::dontSendNotification);
    ...
    stopRecordingToggleButton->setToggleState (true, juce::dontSendNotification);
    ...
    rawSoundLabellabel->setColour (juce::Label::textColourId, juce::Colours::cornflowerblue);
    rawSoundLabellabel->setColour (juce::TextEditor::textColourId, juce::Colours::black);
    rawSoundLabellabel->setColour (juce::TextEditor::backgroundColourId, juce::Colour (0x00000000));
    ...
    guitarStringTonesOffToggleButton->setToggleState (true, juce::dontSendNotification);

    allOffLabel.reset (new juce::Label ("allOffLabel",
                                        TRANS("All off")));
    ...
    allOffLabel->setColour (juce::Label::textColourId, juce::Colours::cornflowerblue);
    allOffLabel->setColour (juce::TextEditor::textColourId, juce::Colours::black);
    allOffLabel->setColour (juce::TextEditor::backgroundColourId, juce::Colour (0x00000000));
    ...
    autoGainToggleButton->setToggleState (true, juce::dontSendNotification);
...
<JUCER_COMPONENT documentType="Component" className="guitarStringSoundsControl"
  ...
  <SLIDER name="stringSlider" id="88f92d492d7e9371" memberName="stringSlider"
          ...
          min="0.0" max="1.0" int="0.1" style="LinearVertical" textBoxPos="NoTextBox"
  ...
  <SLIDER name="recordingLevelSlider" id="b91b5c169ea1058f" memberName="recordingLevelSlider"
          ...
          min="0.0" max="500.0" int="0.01" style="LinearHorizontal" textBoxPos="NoTextBox"
